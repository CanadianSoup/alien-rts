...
namespace CodeMonkey.Utils {
    ...
    public static class UtilsClass {
        ...
        public static TextMesh CreateWorldText(string text, Vector3 cellSize, Transform parent = null, Vector3 localPosition = default(Vector3), int fontSize = 40, Color? color = null, TextAnchor textAnchor = TextAnchor.UpperLeft, TextAlignment textAlignment = TextAlignment.Left, int sortingOrder = sortingOrderDefault)
        {
            if (color == null) color = Color.white;
            return CreateWorldText(parent, text, localPosition, fontSize, (Color)color, textAnchor, textAlignment, sortingOrder, cellSize);
        }

        // Create Text in the World
        public static TextMesh CreateWorldText(Transform parent, string text, Vector3 localPosition, int fontSize, Color color, TextAnchor textAnchor, TextAlignment textAlignment, int sortingOrder, Vector3 cellsize)
        {
            GameObject gameObject = new GameObject("World_Text", typeof(TextMesh), typeof(BoxCollider));
            Transform transform = gameObject.transform;
            transform.SetParent(parent, false);
            transform.localPosition = localPosition;
        ...
        public static TextMesh CreateWorldText(Transform parent, string text, Vector3 localPosition, int fontSize, Color color, TextAnchor textAnchor, TextAlignment textAlignment, int sortingOrder) {
            ...
            transform.localPosition = localPosition;
            BoxCollider boxCollider = gameObject.GetComponent<BoxCollider>();
            boxCollider.size = new Vector3(10, 10);
            boxCollider.center = new Vector3(0, 0);
            TextMesh textMesh = gameObject.GetComponent<TextMesh>();
            textMesh.anchor = textAnchor;
            textMesh.alignment = textAlignment;
