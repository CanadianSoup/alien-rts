...
public class HeatMapVisual : MonoBehaviour
{
    ...
    private void Grid_OnGridObjectChanged(object sender, CustomGrid.OnGridObjectChangedEventArgs e)
    {
        updateMesh = true;
    }
    ...
    private void UpdateHeatMapVisual()
    {
        ...
        for (int x = 0; x < grid.GetWidth(); x++)
        {
            for (int y = 0; y < grid.GetHeight(); y++)
            {
                ...
                float gridValueNormalized = (float) gridValue / CustomGrid.HEAT_MAP_MAX_VALUE;
